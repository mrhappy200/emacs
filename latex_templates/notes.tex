...
\immediate\openout\todofile=\jobname.tdo
...
% h1 kleur
\definecolor{Accent1}{HTML}{E68A1E}

% h2 kleur
\definecolor{Accent2}{HTML}{F0AC1A}

% h3 kleur
\definecolor{Accent3}{HTML}{F6C521}

% h4 kleur
\definecolor{Accent4}{HTML}{FBE106}
...
\renewcommand{\lipsum}[1][1]{\fout[_VAR_ Lipsum (\immediate\currentname)]{Dit is een plek waar tekst hoort te zijn maar die nog niet af is of die niet nodig beschouwd wordt voor deze versie van het document \oldlipsum[#1]}}

\def\projectnaam{Zonnepaneel met richtsysteem}
\title{Profielwerkstuk \projectnaam}
...
\fancyhead[CO,CE]{\textcolor{Accent1}{\textbf{Notes --- \date}}}
